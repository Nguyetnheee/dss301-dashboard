...
const records: Array<TelemetryRecord & { predicted_power_w: number }> = [
  { timestamp: '2026-07-28T09:30:00', mission_id: 'MISSION-001', drone_id: 'DRN-001', altitude_m: 80, speed_mps: 6.2, acceleration_mps2: 0.7, distance_to_base_m: 900, battery_level_pct: 18, flight_time_s: 1100, hover_duration_s: 120, camera_active: 1, ambient_temp_C: 34, wind_speed_mps: 3.8, wind_dir_sin: 0.5, wind_dir_cos: 0.866, hour_sin: 0.609, hour_cos: -0.793, predicted_power_w: 158.4 },
  { timestamp: '2026-07-28T09:32:00', mission_id: 'MISSION-002', drone_id: 'DRN-002', altitude_m: 72, speed_mps: 5.7, acceleration_mps2: 0.5, distance_to_base_m: 640, battery_level_pct: 58, flight_time_s: 760, hover_duration_s: 54, camera_active: 1, ambient_temp_C: 33, wind_speed_mps: 5.4, wind_dir_sin: 0.707, wind_dir_cos: 0.707, hour_sin: 0.609, hour_cos: -0.793, predicted_power_w: 149.8 },
...
export const demoQueue: QueueRecord[] = records.map(({ predicted_power_w, ...record }) => ({
  ...record, predicted_power_w, ...applyDecisionRule(record, predicted_power_w, prototypeRuleConfig), model_version: 'uav_power_regression_v1 (demo)', rule_config: prototypeRuleConfig,
}));
